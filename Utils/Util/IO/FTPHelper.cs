...
namespace Util
{
    public class FTPHelper
    {
        ...
        public FTPHelper()
        {
            ...
            ftpServerIP = app.AppConfigGet("ftpServerIP");
            ftpRemotePath = app.AppConfigGet("ftpRemotePath");
            ftpUserID = app.AppConfigGet("ftpUserID");
            ftpPassword = app.AppConfigGet("ftpPassword");
        ...
        {
            string[] fileList = GetFilesDetailList();
