...
{
    public partial class Q203_ENGForm : ListForm
    {
        Task task1;
        ...
        public override void InitData()
        {
            ...
            task1 = new Task(() =>
            {
                try
                {
                    ...
                    var models = viewService.GetQ203ENG(lbStart, lbEnd);
        ...
        private void pivotGridControl1_CustomSummary(object sender, DevExpress.XtraPivotGrid.PivotGridCustomSummaryEventArgs e)
        {
            ...
            if (e.DataField == fieldQcper)
            {
                for (int i = 0; i < ds.RowCount; i++)
                {
                    PivotDrillDownDataRow row = ds[i];
                    firstn += Convert.ToDecimal(row[fieldENGQtyInK1]); ;
