...
{
    public partial class Y101_DailyYieldSummaryForm : ListForm
    {
        private IViewService viewService = Unity.Instance.GetService<IViewService>();
        public Y101_DailyYieldSummaryForm()
        {
            InitializeComponent();
        }
        ...
        public void ShowData()
        {
            ...
            fieldTDInQty1.Caption = "投入" + "(" + txtProdDt2.DateTime.Day.ToString() + "号)";
            fieldTDOutQty1.Caption = "产出" + "(" + txtProdDt2.DateTime.Day.ToString() + "号)";
            this.pivotGridControl1.DataSource = viewService.GetDailyYieldSummary(lbStart, lbEnd);
